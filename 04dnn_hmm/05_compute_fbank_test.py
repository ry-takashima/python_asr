...
if __name__ == "__main__":
    ...
    # wavファイルリスト
    wav_scp = '../03gmm_hmm/exp/data/test/wav.scp'
    # FBANK出力ディレクトリ
    out_dir = './exp/data/test/fbank'
    # 出力特徴量リストファイル
    out_feat_scp = './exp/data/test/feats.scp'
    ...
    with open(wav_scp, mode='r') as file_wav, \
            open(out_feat_scp, mode='w') as file_feat:
        # wavリストを1行ずつ読み込む
